...
class VerbatimTranscriptionModeParam(TypedDict):
    r"""Configuration for verbatim transcription mode."""
...
class VerbatimTranscriptionMode(BaseModel):
    r"""Configuration for verbatim transcription mode."""
    ...
    type: Annotated[
        Annotated[Literal["verbatim"], AfterValidator(validate_const("verbatim"))],
        pydantic.Field(alias="type"),
    ] = "verbatim"

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["diarization_mode", "timestamp_granularities"])
...
try:
    VerbatimTranscriptionMode.model_rebuild()
except NameError:
    pass
